  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <Typography variant="body1" color="textSecondary">
        Note: xlsx must have very specific column names. Copy this example
        <a
          target="_blank"
          href="https://docs.google.com/spreadsheets/d/14mEUs3y4nEW30mpcCqIRayEwmxQ330l7rTinpQzPX9w/edit?usp=sharing">
          {' '}
          HERE
        </a>
        , make sure to download as xlsx. It is ok to leave some fields blank,
        but you must have the student id (sid) and email. The default password
        is the student id.
      </Typography>
      <TextField
